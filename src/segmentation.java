...
class ImageSegmentation
{
	public void run(String[] args)
	{
		...
		// Load the image
		String filename = args.length > 0 ? args[0] : "E:/EclipseProject/opencv_test/sample_coin.jpg";
		...
		HighGui.resizeWindow("Source Image", 1280, 720);
		...
		HighGui.resizeWindow("Black Background Image", 1280, 720);
		...
		HighGui.resizeWindow("New Sharped Image", 1280, 720);
		// Create binary image from source image
		Mat bw = new Mat();
		Imgproc.cvtColor(imgResult, bw, Imgproc.COLOR_BGR2GRAY);
		// Imgproc.threshold(bw, bw, 40, 255, Imgproc.THRESH_BINARY |
		// Imgproc.THRESH_OTSU);
		Imgproc.GaussianBlur(bw, bw, new Size(5, 5), 3);
		Imgproc.adaptiveThreshold(bw, bw, 255, Imgproc.ADAPTIVE_THRESH_MEAN_C, Imgproc.THRESH_BINARY_INV, 17, 6);

		HighGui.imshow("Binary Image", bw);
		HighGui.resizeWindow("Binary Image", 1280, 720);
		...
		HighGui.resizeWindow("Distance Transform Image", 1280, 720);
		...
		HighGui.resizeWindow("Peaks", 1280, 720);
		...
		HighGui.resizeWindow("Markers", 1280, 720);
		...
		for (int i = 0; i < contours.size(); i++)
		{
			...
			colors.add(new Scalar(255, 255, 255));
		}
		...
		HighGui.resizeWindow("Final Result", 1280, 720);
